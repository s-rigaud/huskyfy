...
export default {
    ...
    getOAuthUrl() {
        ...
        let oauthUrl = `${BASE_URL}?response_type=code&client_id=${CLIENT_ID}&scope=${SCOPES}&redirect_uri=${CURRENT_URL}login`;
    ...
    async requestFirstAccessToken() {
        ...
        await axios({
            ...
            data: `code=${authStore.temporaryToken}&redirect_uri=${CURRENT_URL.split('?')[0]}&grant_type=authorization_code`,
