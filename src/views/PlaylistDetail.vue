<template>
  ...
  <div
    v-if="playlistsStore.playlists[props.playlistId] && playlistsStore.playlists[props.playlistId].total > 0"
    id="playlist-detail"
    v-scroll="onScroll"
  >
    <div id="main-content">
  ...
  <DuplicatorPopup
    ...
    :playlist-id=" playlistsStore.playlists[props.playlistId].id "
